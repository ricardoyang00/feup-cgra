...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        //-- Init cube and apply Textures
        const textures = {
            texTop: this.textureMineTop, 
            texFront: this.textureMineSide, 
            texRight: this.textureMineSide,
            texBack: this.textureMineSide,
            texLeft: this.textureMineSide, 
            texBottom: this.textureMineBottom
        };

        this.cube = new MyUnitCubeQuad(this, textures);
        //-------
