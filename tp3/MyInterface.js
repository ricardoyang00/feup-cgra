...
export class MyInterface extends CGFinterface {
    ...
    init(application) {
        ...
        this.gui.add(this.scene, 'globalAmbientLight', 0.0, 1.0).name('Ambient Light').onChange(() => {
            this.scene.setGlobalAmbientLight(this.scene.globalAmbientLight, this.scene.globalAmbientLight, this.scene.globalAmbientLight, 1.0);
        });
